...
//    }
    ...
    @GetMapping
    public List<PedidoResumidoModelResponse> pesquisar(PedidoFilter filtro){
        return pedidoResumoModelAssembler.toCollectionModelResponse(pedidoService.listarPedidos(filtro));
    }
